...
runTest("hard_and_v2_contracts_survive_exact_sanitize", function()
    ...
    assertEquals(killMeta.stats.coreExit, "hard_punish", "safe kill should be owned by hard punish")
    assertEquals(killMeta.stats.hardSelectionLocked, true, "safe kill should hard lock before V2")
    assertEquals(killMeta.stats.hardSelectionReason, "safe_kill", "safe kill hard reason")
