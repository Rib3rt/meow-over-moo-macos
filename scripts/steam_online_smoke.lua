...
runTest("faction_start_disabled_style_has_no_x_overlay", function()
    ...
    assertTrue(content:find("buttonDef.disabledVisual = visual.disabled == true", 1, true) ~= nil, "faction disabled visual state missing")
    assertTrue(themeContent:find("button.disabledVisual == true", 1, true) ~= nil, "shared disabled visual state guard missing")
